...
class TableViewCell3: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func RetrieveImages() {
        ...
        do {
            ...
            for items in SavedItemsInventory as [NSManagedObject] {
                ...
                if (category == "armorbody") && (itemOrder != "0") {

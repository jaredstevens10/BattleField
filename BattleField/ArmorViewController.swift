...
protocol ArmorViewControllerDelegate: class {
...
class ArmorViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var adelegate: ArmorViewControllerDelegate?
    ...
    var SpeedSelected = NSString()
        ...
        @IBAction func close(_ sender: AnyObject) {
            ...
            adelegate?.ArmorViewControllerFinished(self)
        }
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            armorPKLabel = itemNameInfo[row]
             ...
             prefs.setValue(armorPKLabel, forKey: "HOLDINGARMOR")
            print(armorPKLabel)
            ...
            prefs.setObject(armorPKimage, forKey: "SELECTEDARMOR")
*/
            ...
            self.adelegate?.ArmorViewControllerFinished(self)
